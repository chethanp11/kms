...
- `DEV-025` | `2026-04-06` | The next iteration cannot be scoped exactly because `intent/iteration-intent.md` still contains placeholders instead of concrete direction. | `design defect` | `major` | `resolved` | `design audit` | `REQ-001`, `ACC-001`, `TEST-001`, `EVAL-001`, `DEV-021`
- `DEV-028` | `2026-04-06` | Implementation could not begin because the iteration scope remains undefined while `intent/iteration-intent.md` still contains placeholders. | `design defect` | `major` | `resolved` | `implementation planning` | `REQ-001`, `ACC-001`, `TEST-001`, `EVAL-001`, `DEV-025`
