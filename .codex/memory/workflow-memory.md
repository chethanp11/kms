...
- Evidence: `.codex/AGENTS.md` `Default Prompt Handling`, `.codex/appflow.md` `Automatic Routing`, `.codex/dev_workflow/README.md` `Automatic Prompt Routing`.
- Applies to: Codex CLI, VS Code Codex, Codex Desktop, and future agent sessions.
- Should be promoted to: Already promoted to `.codex/AGENTS.md` and `.codex/appflow.md`.
