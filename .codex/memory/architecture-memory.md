...
- Source artifacts: `.devmode/app.md`, root `AGENTS.md` router, `.codex/project-context.md`.
...
- Source artifacts: root `AGENTS.md` router, `README.md`, `.devmode/app.md`.
...
- Promote durable architecture rules to `.devmode/app.md` or project design docs.
