...
- Date: 2026-05-10
- Scope: Added `.codex/AGENTS.md`, `.codex/appflow.md`, agent roles, skills, workflows, orchestration, context templates, memory templates, rules, prompts, state, and tools.
- Files/modules: `.codex/*`, root `AGENTS.md`, `README.md`, `plan/*`, `dev_log/validation-results.md`.
- Outcome: `.codex/` became a reusable AppFlow factory; root `AGENTS.md`, `.codex/project-context.md`, and `.codex/tech-stack.md` remain project-specific.
...
- Files/modules: `.codex/dev_workflow/*`, `.codex/AGENTS.md`, `.codex/appflow.md`, root `AGENTS.md`, `README.md`.
